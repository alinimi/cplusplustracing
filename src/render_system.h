...
namespace render {
    ...
    public:
        ...
        void render_pixel(ECS& ecs, const Camera& cam, int x, int y, std::vector<color>& pixel_colors, RNG& rng);
        void render_tile(
        ...
        std::vector<float> render_ecs(ECS& ecs, const Camera& cam, RNG& rng);
